...
| Durum | MCP'ler | Sınır |
| --- | --- | --- |
| <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2705.svg" alt="" aria-hidden="true" width="20"> Varsayılan açık | OpenAI Docs, Context7, Sequential Thinking, Playwright, Chrome DevTools, Serena, Memory | Araştırma, code navigation, browser evidence ve secret içermeyen lokal context. |
| <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f512.svg" alt="" aria-hidden="true" width="20"> Opt-in bekler | Filesystem, GitHub, Figma, Linear, Notion, Sentry, Vercel, Supabase | Özel dosya, hesap, deploy, telemetry veya database verisi açabileceği için kapalı başlar. |
