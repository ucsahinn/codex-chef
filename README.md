...
| --- | --- | --- |
| <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2705.svg" alt="" aria-hidden="true" width="20"> Enabled by default | OpenAI Docs, Context7, Sequential Thinking, Playwright, Chrome DevTools, Serena, Memory | Research, code navigation, browser evidence, and non-secret local context. |
| <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f512.svg" alt="" aria-hidden="true" width="20"> Disabled until opt-in | Filesystem, GitHub, Figma, Linear, Notion, Sentry, Vercel, Supabase | These can expose private files, accounts, deployments, telemetry, or databases. |
