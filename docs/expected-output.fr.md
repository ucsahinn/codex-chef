...
> Les exemples complets de sortie et les details operateur sont dans
> [English](expected-output.md) et [Türkçe](expected-output.tr.md). Cette page
> localisee est un resume de securite avec index des sources.
