...
> Este guia em português do Brasil faz parte do conjunto de documentação em seis idiomas para `windows.md`. Ele mantém o mesmo limite de segurança: prever primeiro, não armazenar segredos e verificar localmente cada mudança de setup.
...
Este arquivo localizado acompanha as seções do arquivo fonte em inglês. Source: [windows.md](windows.md).
