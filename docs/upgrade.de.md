...
> Diese deutsche Anleitung ist Teil des sechssprachigen Dokumentationssatzes fuer `upgrade.md`. Sie behält dieselbe Sicherheitsgrenze bei: zuerst eine Vorschau ausführen, keine Secrets speichern und jede Setup-Aenderung lokal verifizieren.
...
Diese lokalisierte Datei folgt den Abschnitten der englischen Quelldatei. Source: [upgrade.md](upgrade.md).
