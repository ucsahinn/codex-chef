...
> Esta guía en español forma parte del conjunto de documentación en seis idiomas para `how-to.md`. Mantiene el mismo límite de seguridad: previsualizar primero, no guardar secretos y verificar localmente cada cambio de setup.
...
Este archivo localizado sigue las secciones del archivo fuente en inglés. Source: [how-to.md](how-to.md).
