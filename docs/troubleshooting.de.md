...
> Diese deutsche Anleitung ist Teil des sechssprachigen Dokumentationssatzes fuer `troubleshooting.md`. Sie behält dieselbe Sicherheitsgrenze bei: zuerst eine Vorschau ausführen, keine Secrets speichern und jede Setup-Aenderung lokal verifizieren.
...
Diese lokalisierte Datei folgt den Abschnitten der englischen Quelldatei. Source: [troubleshooting.md](troubleshooting.md).
