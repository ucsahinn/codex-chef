...
git commit -m "Release Codex Chef v0.5.48"
git push origin main
git tag v0.5.48
git push origin v0.5.48
gh release create v0.5.48 --title "Codex Chef v0.5.48" --notes-file tmp/release-notes-current.md
```
