...
> Diese deutsche Anleitung ist Teil des sechssprachigen Dokumentationssatzes fuer `research-notes.md`. Sie behält dieselbe Sicherheitsgrenze bei: zuerst eine Vorschau ausführen, keine Secrets speichern und jede Setup-Aenderung lokal verifizieren.
...
Diese lokalisierte Datei folgt den Abschnitten der englischen Quelldatei. Source: [research-notes.md](research-notes.md).
